    ...
    public partial class ServiceBase : INotifyPropertyChanged
    {
        ...
        public bool NotifyEn
        {
            ...
            set
            {
                ...
                {
                    _notifyEn = value;
                    if (_notifyEn) NotifyAr = NotifyFr = false; // clear the other
        ...
        public bool NotifyAr
        {
            ...
            set
            {
                ...
                {
                    _notifyAr = value;
                    if (_notifyAr) NotifyEn = NotifyFr = false; // clear the other
                    OnPropertyChanged(nameof(NotifyAr));
                }
            }
        }

        private bool _notifyFr;
        public bool NotifyFr
        {
            get => _notifyFr;
            set
            {
                ...
                {
                    _notifyFr = value;
                    if (_notifyFr) NotifyEn = NotifyAr = false; // clear the other
                    OnPropertyChanged(nameof(NotifyFr));
                }
            }
        }
